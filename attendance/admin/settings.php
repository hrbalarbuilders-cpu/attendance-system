  ...
  <div class="settings-wrapper w-100">
    ...
    <div class="mb-4">
      <div class="top-nav-wrapper">
        <button class="top-nav-pill active" data-page="settings_shift_tab.php">
          <span class="icon">📊</span>
          <span>Shift Master</span>
        </button>
        <button class="top-nav-pill" data-page="settings_location_tab.php">
          <span class="icon">📍</span>
          <span>Location</span>
        </button>
        <button class="top-nav-pill" data-page="settings_leaves_tab.php">
          <span class="icon">📝</span>
          <span>Leaves</span>
        </button>
        <button class="top-nav-pill" data-page="settings_workingfrom_tab.php">
          <span class="icon">🏠</span>
