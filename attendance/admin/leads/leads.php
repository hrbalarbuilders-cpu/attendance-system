...
<head>
	...
	<style>
		...
		#leadsList .table-responsive {
			overflow-x: auto !important;
			border-radius: 8px;
		}

		#leadsList #leadsTable {
			width: 100%;
			min-width: 1000px;
			/* Force scroll on smaller screens instead of squashing */
		}

		#leadsList #leadsTable th {
			white-space: nowrap;
			background: #f8fafc;
			font-size: 0.85rem;
		...
		#leadsList #leadsTable td {
			font-size: 0.9rem;
			padding: 10px 8px;
		}

		/* Keep dropdown menu above the table/footer */
		#leadsList .dropdown-menu {
			z-index: 5005;
		}
	</style>
</head>
