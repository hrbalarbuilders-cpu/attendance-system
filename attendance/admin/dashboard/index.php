...
if (!$employee) {
  $empList = $con->query("SELECT user_id, name, emp_code, profile_img FROM employees WHERE status = 1 ORDER BY name ASC");
}
    ...
    <div class="employee-selector-card">
      ...
      <div class="employee-grid">
        <?php while ($emp = $empList->fetch_assoc()): ?>
          <a href="?emp_id=<?php echo $emp['user_id']; ?>" class="employee-card">
            <div class="avatar">
  ...
  <?php else: ?>
    ...
    <div class="stats-row">
      ...
      <div class="stat-card">
        ...
        <div class="value"><?php echo $todayClockOut ? date('h:i A', strtotime($todayClockOut['time'])) : '--:--'; ?>
        </div>
      </div>
      <div class="stat-card">
