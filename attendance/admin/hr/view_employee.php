            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body p-4">
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col ps-0">
                            <h3 class="mb-0 fw-semibold"><?php echo htmlspecialchars($employee['name'] ?? '-'); ?></h3>
                            <div class="text-muted small">Employee Code: <?php echo htmlspecialchars($employee['emp_code'] ?? '-'); ?></div>
                        </div>
                        <div class="col-auto">
                            <span class="badge bg-<?php echo ((int)($employee['status'] ?? 1) === 1) ? 'success' : 'secondary'; ?> px-3 py-2" style="font-size:1rem;">
                    ...
                    <div class="row g-3 mb-2">
                        <div class="col-md-6">
                            ...
                            <div class="fw-semibold"><?php echo htmlspecialchars($employee['department_name'] ?? '-'); ?></div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-2 text-muted small">Designation</div>
                            <div class="fw-semibold"><?php echo htmlspecialchars($employee['designation_name'] ?? '-'); ?></div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-2 text-muted small">Mobile</div>
                            <div class="fw-semibold"><?php echo htmlspecialchars($employee['mobile'] ?? '-'); ?></div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-2 text-muted small">Email</div>
                            <div class="fw-semibold"><?php echo htmlspecialchars($employee['email'] ?? '-'); ?></div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-2 text-muted small">Date of Birth</div>
                            <div class="fw-semibold"><?php echo !empty($employee['dob']) ? date('d M Y', strtotime($employee['dob'])) : '-'; ?></div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-2 text-muted small">Joining Date</div>
                            <div class="fw-semibold"><?php echo !empty($employee['joining_date']) ? date('d M Y', strtotime($employee['joining_date'])) : '-'; ?></div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-2 text-muted small">Shift</div>
                            <div class="fw-semibold"><?php echo htmlspecialchars($employee['shift_name'] ?? '-'); ?></div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="fw-semibold"><?php echo htmlspecialchars($employee['default_working_from'] ?? '-'); ?></div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="fw-semibold"><?php echo $employee['device_id'] ? htmlspecialchars($employee['device_id']) : 'Not registered'; ?></div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="fw-semibold"><?php echo !empty($employee['created_at']) ? date('d M Y, h:i A', strtotime($employee['created_at'])) : '-'; ?></div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-2 text-muted small">Updated At</div>
                            <div class="fw-semibold"><?php echo !empty($employee['updated_at']) ? date('d M Y, h:i A', strtotime($employee['updated_at'])) : '-'; ?></div>
                        </div>
                    </div>
                </div>
            </div>
