...
$employeesList = [];
$empRes = $con->query("SELECT id, emp_code, name FROM employees ORDER BY name ASC");
                            ...
                            <?php if ($result && $result->num_rows): ?>
                                <?php
                                    ...
                                    while($row = $result->fetch_assoc()):
                                        ...
                                        else if ($status === 'approved') $badgeClass = 'success';
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <span class="badge bg-<?php echo $badgeClass; ?><?php echo $badgeClass === 'warning' ? ' text-dark' : ''; ?>">
                ...
                <nav class="mt-3 px-2">
                    <ul class="pagination mb-0">
                        <?php
                            ...
                            if ($page > 1) echo '<li class="page-item"><a href="#" class="page-link leaves-page-link" data-page="'.($page-1).'">Previous</a></li>';
                            if ($start > 1) echo '<li class="page-item"><a href="#" class="page-link leaves-page-link" data-page="1">1</a></li>' . ($start>2 ? '<li class="page-item disabled"><span class="page-link">...</span></li>':'' );
                            for ($p = $start; $p <= $end; $p++){
                                $cls = $p == $page ? ' page-item active' : ' page-item';
                                echo '<li class="'.$cls.'"><a href="#" class="page-link leaves-page-link" data-page="'.$p.'">'.$p.'</a></li>';
                            }
                            if ($end < $totalPages) echo ($end < $totalPages-1 ? '<li class="page-item disabled"><span class="page-link">...</span></li>':'') . '<li class="page-item"><a href="#" class="page-link leaves-page-link" data-page="'.$totalPages.'">'.$totalPages.'</a></li>';
                            if ($page < $totalPages) echo '<li class="page-item"><a href="#" class="page-link leaves-page-link" data-page="'.($page+1).'">Next</a></li>';
                        ?>
                    </ul>
                </nav>
            <?php endif; ?>
