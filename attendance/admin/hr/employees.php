                    ...
                    <div class="row g-4">
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="d-flex align-items-center gap-4 mt-1 flex-wrap">
                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="mark_by" id="markByDate" value="date"
                              checked>
      ...
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 rounded-4">
          ...
          <div class="modal-header border-0 pb-0 d-flex justify-content-between align-items-center">
            ...
            <div>
              <button type="button" class="btn btn-sm btn-outline-danger me-2" id="deleteAttendanceBtn"
                style="display:none;">
                🗑️
              </button>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  ...
                  <div class="position-relative d-inline-block" style="width: 150px; height: 150px;">
                    <svg class="transform-rotate-90" width="150" height="150">
                      ...
                      <circle cx="75" cy="75" r="70" stroke="#6366F1" stroke-width="8" fill="none"
                        stroke-dasharray="440" stroke-dashoffset="0" id="workProgressCircle" stroke-linecap="round"
                        style="transition: stroke-dashoffset 0.5s;" />
                      <!-- Break (yellow) -->
                      <circle cx="75" cy="75" r="70" stroke="#FACC15" stroke-width="8" fill="none"
                        stroke-dasharray="440" stroke-dashoffset="0" id="breakProgressCircle" stroke-linecap="round"
                        style="transition: stroke-dashoffset 0.5s; display:none;">
                        <title id="breakTooltip"></title>
                      </circle>
                      <!-- Late (orange/red) -->
                      <circle cx="75" cy="75" r="70" stroke="#F97373" stroke-width="8" fill="none"
                        stroke-dasharray="440" stroke-dashoffset="0" id="lateProgressCircle" stroke-linecap="round"
                        style="transition: stroke-dashoffset 0.5s; display:none;">
