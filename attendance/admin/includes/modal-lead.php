...
?>
<style>
  /* Use design system variables for consistent look */
  .modal-backdrop.show {
    backdrop-filter: blur(4px);
    -webkit-backdrop-filter: blur(4px);
    /* z-index is handled globally by components.css (9998) */
  }
        ...
        <div class="container-fluid p-0">
          <div class="row g-3">
            ...
            <div class="col-12 col-md-6">
              ...
              <div class="dropdown">
                <button class="btn btn-outline-secondary dropdown-toggle w-100 text-start" type="button"
                  id="leadLookingForSubtypeBtn" data-bs-toggle="dropdown" aria-expanded="false">Select subtypes</button>
                <div class="dropdown-menu p-2" id="leadLookingForSubtypeMenu"
                  style="max-height:220px; overflow:auto; min-width:250px;">
            ...
            <div class="col-12 col-md-6">
              ...
              <input name="reference" id="leadReference" class="form-control" placeholder="e.g. Referral name">
            </div>
        ...
        if (data && data.sources) {
          ...
          if (pref) {
            try {
              ...
              var map = ['leadId', 'leadName', 'leadContact', 'leadEmail', 'leadProfile', 'leadPincode', 'leadCity', 'leadState', 'leadCountry', 'leadPurpose', 'leadNotes', 'leadReference'];
